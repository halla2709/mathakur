...
router.get('/data/getAllSchools', getSchools, function (req, res, next) {
    res.json(req.schools);
});

router.get('/data/getSchool/:id', getSchools, function(req, res, next) {
    res.end();
});

router.post('/data/addSchool', addSchool, function (req, res, next) {
    res.end();
});
